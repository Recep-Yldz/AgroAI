  ...
  <table style="border: none;">
    <tr>
      <td width="50%" align="center">
        <img src="assets/setup.jpg" alt="Kurulum Sayfası" width="250px"/><br>
        <b>1. Kurulum ve Cihaz Eşleştirme</b><br>
        <em>(MQTT Broker ve API Yapılandırması)</em>
      </td>
      <td width="50%" align="center">
        <img src="assets/dashboard.jpg" alt="Anasayfa" width="250px"/><br>
